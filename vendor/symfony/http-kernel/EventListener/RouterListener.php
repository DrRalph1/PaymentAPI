...
class RouterListener implements EventSubscriberInterface
{
    ...
    public function onKernelRequest(RequestEvent $event)
    {
        ...
        try {
            ...
            $message = sprintf('No route found for "%s %s": Method Not Allowed (Allow: %s)', $request->getMethod(), $request->getPathInfo(), implode(', ', $e->getowedMethods()));

            throw new MethodNotAllowedHttpException($e->getowedMethods(), $message, $e);
        }
    }
